...
export default function Products() {
  ...
  const { allProducts, loading, error, refetch, goToNextPage,
    goToPreviousPage,
    goToPage,
    changeItemsPerPage,    pagination,
  ...
  const handleSearch = useCallback((term) => {
    ...
    // Set a timeout to update the actual search term after user stops typing
  ...
  ], [toggleActions, handleShowDelete, handleShowForm, activeRow]);
  ...
  return (
    <div className="p-8 space-y-6">
      ...
      />
      <Table columns={columns} data={tableData}      pagination={pagination}
